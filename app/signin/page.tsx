...
function Signin() {
    ...
    return (
        ...
        <h1 className="text-center font-semibold text-2xl md:text-3xl mt-7 text-zinc-600">Bem vindo de novo!</h1>
    
        <div className="min-w-[25rem] w-3/5 h-96 mx-auto mt-8 flex flex-col gap-3 border shadow-sm rounded-md">
