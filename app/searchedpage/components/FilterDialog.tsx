...
export const FilterDialog = () => {
    ...
    function addPropertyInformations() {
        ...
        dispatch(setFilterValues({constructorInformations: checkboxVal}))
    }
    ...
    return (
        ...
        <DialogContent className="w-[28rem] md:w-[70%] h-[70%] overflow-y-auto rounded-md overflow-x-hidden">
          <DialogHeader>
            <DialogTitle className=" text-start md:text-start text-2xl border-b-[1px] border-b-black pb-2">Filtros de imóveis</DialogTitle>
        
            <DialogDescription className="flex flex-col items-center justify-start pt-6 space-y-6">

                <section className="min-w-[70%] md:min-w-full max-w-full flex flex-col md:flex-row justify-between items-center px-8 border-b-[3px] pb-6">
                    <h3 className="text-2xl">Banheiros</h3>

                    <div className=" flex space-x-2 justify-center items-center">
                        <span className={`flex items-center justify-center rounded-full cursor-pointer
                        border-black border-[1px] w-12 h-12 text-xl ${bathrooms == 1 ? "bg-black text-white" : ""}`} onClick={() => bathrooms == 1 ? setBathrooms(0) : setBathrooms(1)}>
                            1
                        </span>
                        <span className={`flex items-center justify-center rounded-full cursor-pointer
                        border-black border-[1px] w-12 h-12 text-xl ${bathrooms == 2 ? "bg-black text-white" : ""}`} onClick={() => bathrooms == 2 ? setBathrooms(0) : setBathrooms(2)}>
                            2
                        </span>
                        <span className={`flex items-center justify-center rounded-full cursor-pointer
                        border-black border-[1px] w-12 h-12 text-xl ${bathrooms == 3 ? "bg-black text-white" : ""}`} onClick={() => bathrooms == 3 ? setBathrooms(0) : setBathrooms(3)}>
                            3
                        </span>
                        <span className={`flex items-center justify-center rounded-full cursor-pointer
                        border-black border-[1px] w-12 h-12 text-xl ${bathrooms == 4 ? "bg-black text-white" : ""}`} onClick={() => bathrooms == 4 ? setBathrooms(0) : setBathrooms(4)}>
                            4+
                        </span>
                    </div>
                </section>      
                ...
                <section className="min-w-full max-w-full flex flex-col md:flex-row justify-between items-center px-8 border-b-[3px] border-b-black] pb-6">
                    ...
                    <div className=" flex space-x-2 justify-center items-center">
                        <span className={`flex items-center justify-center rounded-full cursor-pointer
                        border-black border-[1px]  w-12 h-12 md:w-12 md:h-12 text-xl  ${carSpace == 1 ? "bg-black text-white" : ""}`} onClick={() => carSpace == 1 ? setCarSpace(0) : setCarSpace(1)}>
                            1
                        </span>
                        <span className={`flex items-center justify-center rounded-full cursor-pointer
                        border-black border-[1px]  w-12 h-12 md:w-12 md:h-12 text-xl  ${carSpace == 2 ? "bg-black text-white" : ""}`} onClick={() => carSpace == 2 ? setCarSpace(0) : setCarSpace(2)}>
                            2
                        </span>
                        <span className={`flex items-center justify-center rounded-full cursor-pointer
                        border-black border-[1px]  w-12 h-12 md:w-12 md:h-12 text-xl  ${carSpace == 3 ? "bg-black text-white" : ""}`} onClick={() => carSpace == 3 ? setCarSpace(0) : setCarSpace(3)}>
                            3+
                        </span>
                    </div>
                </section>      
                ...
                <section className="w-full max-w-full pb-6 border-b-black border-b-[1px]">
                    ...
                    <CustomcheckBox description="Sem mobília" handleCheckBox={handleCheckbox} checkBoxStateValue={checkboxVal}/>
                    <CustomcheckBox description="Mobiliado" handleCheckBox={handleCheckbox} checkBoxStateValue={checkboxVal}/>
          ...
          <DialogFooter className="min-w-full max-w-full gap-4 md:gap-0 flex justify-between items-center mt-4 -ml-6 -md:ml-12">
